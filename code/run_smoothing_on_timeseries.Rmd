...
print(paste0("Distance from black to purple: ", eg_econ_full_dtw$distance))
...
print(paste0("Distance from black to red: ", eg_econ_short_dtw$distance))
...
print(paste0("Distance from black to green: ", eg_uncor_dtw$distance))
```